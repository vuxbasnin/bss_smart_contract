...
export interface BSSTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface BSSToken extends BaseContract {
  connect(runner?: ContractRunner | null): BSSToken;
  waitForDeployment(): Promise<this>;

  interface: BSSTokenInterface;
