...
export interface BSSCrowSaleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BNB_rate"
      | "USDT_rate"
...
export interface BSSCrowSale extends BaseContract {
  connect(runner?: ContractRunner | null): BSSCrowSale;
  waitForDeployment(): Promise<this>;

  interface: BSSCrowSaleInterface;
